...
1
00asd2491859/CS4high_loop-4080E022
 Code Issues 0 Pull requests 0 Projects 0 Wiki Security Insights Settings
CS4high_loop-4080E022/小測驗.md.
@asd2491859 asd2491859 Create 小測驗.md.
d8673d2 7 minutes ago
60 lines (46 sloc)  1.22 KB
...
(A)ant   (B)abcdef  (C)出現錯誤,無法印出  (D)10*20*(546-542)
```
```
答案是:D
```
